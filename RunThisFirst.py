...
#Uses AIRMON-NG, WIFITE, AND FLUXION
...
def menuSystem():
    ...
    print("")
    print("Please install wifite, fluxion, airmon-ng package, and reaver if you do not have them!!!")
    print("")
...
def startWPSCracking():
    print("***Enter Ctrl+C when ready to stop***")
    time.sleep(1)
...
def reaverKillProcess():
    ...
    if question == "Y":
        print("***Killing processes that could interrupt airmon-ng!***")
...
# This is asking the user if they would like to kill processes
def killProcess():
    question = raw_input("Airmon-ng check kill? Y/n: ")
    if question == "Y":
